(function(){
  ...
  function renderList(){
    ...
    list.forEach(b=>{
      ...
      card.className = 'biz-card' + (b.featured ? ' featured' : '');
        ...
        <div class="biz-top">
          <div class="biz-identity">
            ...
            <div>
              ...
              <div class="biz-name">${escapeHtml(b.name)} ${b.featured ? '<span class="featured-badge">⭐ Mise en avant</span>' : ''}</div>
        ...
        <div class="biz-top">
          <div class="biz-identity">
            ...
            <div>
              ...
              <div class="biz-name">${escapeHtml(biz.name)} ${biz.featured ? '<span class="featured-badge">⭐ Mise en avant</span>' : ''}</div>
            </div>
          </div>
        </div>
