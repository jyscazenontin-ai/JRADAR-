(function(){
  ...
  // ---------- Bouton de recherche rapide (nav) ----------
  document.getElementById('searchBtn').addEventListener('click', ()=>{
    document.querySelectorAll('.tab-btn').forEach(b=>b.classList.remove('active'));
    document.querySelector('.tab-btn[data-tab="discover"]').classList.add('active');
    document.querySelectorAll('section').forEach(s=>s.classList.remove('active'));
  ...
  // ---------- Ouvrir le bon onglet si on arrive via un lien #discover ou #register ----------
  function applyHashTab(){
    const hash = window.location.hash.replace('#','');
    if(hash === 'register' || hash === 'discover'){
      document.querySelectorAll('.tab-btn').forEach(b=>b.classList.remove('active'));
      document.querySelector(`.tab-btn[data-tab="${hash}"]`).classList.add('active');
      document.querySelectorAll('section').forEach(s=>s.classList.remove('active'));
